...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="${ctx}/static/back/css/global.css" media="all">
	...
	<body>
		<div class="layui-layout layui-layout-admin">
					...
					<ul class="layui-nav admin-header-item">
						...
						<li class="layui-nav-item">
							<a href="javascript:;" class="admin-header-user">
								<img src="${ctx}/static/back/images/0.jpg" />
								<span>beginner</span>
							</a>
			...
			<script type="text/javascript" src="${ctx}/static/back/datas/nav.js"></script>
			<script src="${ctx}/static/back/js/index.js"></script>
			<script>
